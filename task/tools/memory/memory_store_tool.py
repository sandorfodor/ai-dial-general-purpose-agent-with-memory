...
class StoreMemoryTool(BaseTool):
    ...
    def description(self) -> str:
        return ("Store important, novel facts about the user for long-term memory. Use this to remember user preferences, "
                "personal information, goals, plans, and important context. Only store significant facts that would be "
                "useful to recall in future conversations. Avoid storing temporary information or conversation-specific details.")
    ...
    async def _execute(self, tool_call_params: ToolCallParams) -> str:
        ...
        stage.append_content(f"## Stored Memory\n")
